...
def lambda_handler(event, context):
    ...
    if (event['session']['application']['applicationId'] !=
             "amzn1.echo-sdk-ams.app.5e2ef69c-6949-49da-b75c-e32dc27f85ac"):
...
def on_intent(intent_request, session):
    ...
    if intent_name == "AnagramIntent":
        return get_anagram(intent, session)
...
def get_welcome_response():
    ...
    speech_output = "Welcome to Ken's Anagram App. " \
                    "Please say anagram and then spell out a word for me. "
